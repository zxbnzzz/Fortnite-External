...
// (_XOR_ceptionally using templates here but we could also redefine them for those types)
...
namespace ImGui
{
    ...
    IMGUI_API bool          TabButtonEx(const char* ico, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          OptButtonEx(const char* ico, const ImVec2& size_arg = ImVec2(0, 0), bool rotation = false, ImGuiButtonFlags flags = 0);

...
namespace ImGui
{
    ...
    IMGUI_API bool          TabButton(const char* ico, const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    IMGUI_API bool          OptButton(const char* ico, const ImVec2& size = ImVec2(0, 0), bool rotation = false);   // button
    ...
    IMGUI_API void          ColorConvertHSVtoRGB(int h, int s, int v, int& out_r, int& out_g, int& out_b);
...
enum ImGuiKey : int
{
    ...
    // Keyboard Modifiers (_XOR_plicitly submitted by backend via AddKeyEvent() calls)
...
struct ImGuiListClipper
{
    ...
    int             DisplayEnd;         // End of items to display (_XOR_clusive)
...
namespace ImGui
{
    ...
    IMGUI_API bool      ImageButton(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), int frame_padding = -1, const ImVec4& bg_col = ImVec4(0, 0, 0, 0), const ImVec4& tint_col = ImVec4(1, 1, 1, 1)); // Use new ImageButton() signature (_XOR_plicit item id, regular FramePadding)

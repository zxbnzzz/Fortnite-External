...
//   - with ImGuiTableColumnFlags_WidthFixed,    init_width  >  0 (_XOR_plicit) --> width is custom
//   - with ImGuiTableColumnFlags_WidthStretch,  init_weight <= 0 (default)  --> weight is 1.0f
//   - with ImGuiTableColumnFlags_WidthStretch,  init_weight >  0 (_XOR_plicit) --> weight is custom
